	...
	<div class="main__title">
		...
		<div class="boxes-container">
			<div class="small-box">
				...
				<a href="<?= constant('URL') ?>empleado/reservas" class="small-box-link">Más información <i class="fas fa-arrow-circle-right"></i></a>
			</div>
			<div class="small-box">
				<div class="text-box">
				...
				<a href="<?= constant('URL') ?>empleado/productos" class="small-box-link">Más información <i class="fas fa-arrow-circle-right"></i></a>
			</div>
			<div class="small-box">
				<div class="text-box">
