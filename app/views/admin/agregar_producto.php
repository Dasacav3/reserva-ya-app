...
<body> 
	...
	?>
	<div class="container">
		<form  action="http://localhost/reservaya-mvc/app/models/admin/productos/verificar_agregar_productos.php" method="post"  class="contact" id="contact"  enctype="multipart/form-data" autocomplete="OFf">
			<br>
