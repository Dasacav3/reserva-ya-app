...
<body>
	...
	?>
	<div class="container">
		<form action="<?= constant('URL') ?>app/models/admin/productos/verificar_agregar_productos.php" method="post" class="contact" id="contact" enctype="multipart/form-data" autocomplete="OFf">
			<br>
			...
			<br>
			<input type="number" min="1" id="CANTIDAD_PRODUCTO" name="CANTIDAD_PRODUCTO" class="CANTIDAD_PRODUCTO">
			<br>
			<label for="VALOR_PRODUCTO">Valor producto</label>
			<br>
			<input type="number" min="1" name="VALOR_PRODUCTO" id="VALOR_PRODUCTO" class="VALOR_PRODUCTO">
			<br>
			...
			<br>
			<input type="file" name="IMAGEN_PRODUCTO" id="IMAGEN_PRODUCTO	" class="IMAGEN_PRODUCTO" accept="image/png, .jpeg, .jpg, image/gif">
			<br>
