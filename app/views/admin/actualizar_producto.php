...
<body>
	...
	<div class="container">
		...
		<form action="<?= constant('URL') ?>app/models/admin/productos/verificar_actualizar.php" method="post" class="contact" id="contact" enctype="multipart/form-data" autocomplete="off">
