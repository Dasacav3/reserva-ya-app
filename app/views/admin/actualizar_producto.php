...
<body>
 ...
 <div class="container">
		...
		<form action="http://localhost/reservaya-mvc/app/models/admin/productos/verificar_actualizar.php" method="post"  class="contact" id="contact"  enctype="multipart/form-data" autocomplete="off">
