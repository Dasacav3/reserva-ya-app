  ...
  <body id="body">
    <div class="container">
      ...
      <main class="main__container">
        <div>
            <h2 class="title_table">Elimina Proveedores</h2>
        </div>
        <div style="background-color: white;">
          <form action="eliminaprov2.php" method="post">
            ...
            <a href="http://localhost/reservaya-mvc/app/views/admin/dashboard.php"><input type="button" value="volver"></a>
          </form>
        </div>
      </main>
      <div id="sidebar">
        ...
        <div class="sidebar__menu">
          <div class="sidebar__link">
            ...
            <a href="../../../views/admin/dashboard.php">Inicio</a>
          </div>
          <div class="sidebar__link">
            <i class="fa fa-id-card" aria-hidden="true"></i>
            <a href="../../../views/admin/usuarios/updateInfo.php">Actualizar información</a>
          </div>
          <div class="sidebar__link">
            <i class="fas fa-book"></i>
            <a href="../../../views/admin/reservas/reserva.php">Reservaciones</a>
          </div>
          <div class="sidebar__link">
            <i class="fa fa-archive"></i>
            <a href="../../../views/admin/mesas/mesas.php">Mesas</a>
          </div>
          <div class="sidebar__link">
            <i class="fa fa-utensils"></i>
            <a href="../../../views/admin/productos/productos.php">Productos</a>
          </div>
          <div class="sidebar__link">
            <i class="fa fa-check-circle"></i>
            <a href="../../../views/admin/insumos/insumos.php">Insumos</a>
          </div>
          <div class="sidebar__link active_menu_link">
            <i class="fa fa-truck"></i>
            <a href="../../../views/admin/proveedores/proveedores.php">Proveedores</a>
          </div>
          <div class="sidebar__link">
            <i class="fa fa-user"></i>
            <a href="../../../views/admin/usuarios/usuarios.php">Usuarios</a>
          </div>
          <div class="sidebar__link">
            <i class="fa fa-address-book"></i>
            <a href="../../../views/admin/informacion/informacion.php">información</a>
          </div>
          <div class="sidebar__link">
            <i class="fa fa-question-circle"></i>
            <a href="../../../views/admin/informacion/soporte.php">Soporte</a>
          </div>
