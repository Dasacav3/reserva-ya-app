			...
			<header class="nav-bar">
				...
				<nav class="nav-bar__nav">
					<ul class="nav-bar__nav-ul">
						...
						<li class="nav-bar__nav-ul-li">
							<a href="#navNosotros" class="nav-bar-link">Nosotros</a>
						</li>
						<li class="nav-bar__nav-ul-li">
		...
		<section class="nosotros" id="navNosotros">
			<div class="nosotros-container">
				...
				<div class="nosotros-item | nosotros-item__img">
					<img src="./app/views/dist/img/Logo-Sephia_PUB.jpg" alt="" />
				</div>
			</div>
		</section>
		...
		<section class="contacto" id="navContacto">
			<div class="contacto-container">
				...
				<div class="contacto-map">
					<iframe
						src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2812.089906532743!2d-74.17683276608899!3d4.612686234300271!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e3f9e6139b71409%3A0xfe538fa4d3a6855!2sSephia%20Pub!5e0!3m2!1ses!2sco!4v1608993906768!5m2!1ses!2sco"
						frameborder="0"
						style="border: 0"
						allowfullscreen=""
						aria-hidden="false"
