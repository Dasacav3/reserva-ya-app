...
CREATE TABLE IF NOT EXISTS `auditoria_reservacion` (
  ...
  `AUDI_ACCION` varchar(45) NOT NULL,
  PRIMARY KEY (`ID_AUDI`)
) ENGINE=InnoDB AUTO_INCREMENT=4075 DEFAULT CHARSET=utf8mb4;
...
DELIMITER //
CREATE TRIGGER `AUDITORIA_DELETE_ADMIN` AFTER DELETE ON `administrador` FOR EACH ROW insert INTO auditoria_admin
...
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `AUDITORIA_DELETE_CATEGORIA_INSUMO` AFTER DELETE ON `categoria_insumo` FOR EACH ROW insert into auditoria_categoria_insumo
...
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `AUDITORIA_DELETE_CATEGORIA_PRODUCTO` AFTER DELETE ON `categoria_producto` FOR EACH ROW insert into auditoria_categoria_producto
...
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `AUDITORIA_DELETE_CLIENTE` AFTER DELETE ON `cliente` FOR EACH ROW insert into auditoria_cliente
...
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `AUDITORIA_DELETE_EMPLEADO` AFTER DELETE ON `empleado` FOR EACH ROW insert into auditoria_empleado
...
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `AUDITORIA_DELETE_INSUMO` AFTER DELETE ON `insumo` FOR EACH ROW insert into auditoria_insumo
...
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `AUDITORIA_DELETE_MESA` AFTER DELETE ON `mesa` FOR EACH ROW insert into auditoria_mesa
...
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `AUDITORIA_DELETE_PRODUCTO` AFTER DELETE ON `producto` FOR EACH ROW insert into auditoria_producto
...
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `AUDITORIA_DELETE_PROVEEDOR` AFTER DELETE ON `proveedor` FOR EACH ROW insert into auditoria_proveedor
...
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `AUDITORIA_DELETE_RESERVACION` AFTER DELETE ON `reservacion` FOR EACH ROW insert into auditoria_reservacion
(ID_CLIENTE_ANTERIOR,
...
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `AUDITORIA_DELETE_RESERVACION_RESERVA_MESA` AFTER DELETE ON `reservacion_reserva_mesa` FOR EACH ROW insert into auditoria_reservacion_reserva_mesa
...
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `AUDITORIA_DELETE_USUARIO` AFTER DELETE ON `usuario` FOR EACH ROW insert into auditoria_usuario
...
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `AUDITORIA_INSERT_ADMIN` BEFORE INSERT ON `administrador` FOR EACH ROW insert into auditoria_admin
(NOMBRE_ADMIN_NUEVO,
...
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `AUDITORIA_INSERT_CATEGORIA_INSUMO` BEFORE INSERT ON `categoria_insumo` FOR EACH ROW insert into auditoria_categoria_insumo
...
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `AUDITORIA_INSERT_CATEGORIA_PRODUCTO` BEFORE INSERT ON `categoria_producto` FOR EACH ROW insert into auditoria_categoria_producto
...
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `AUDITORIA_INSERT_CLIENTE` BEFORE INSERT ON `cliente` FOR EACH ROW insert into auditoria_cliente
...
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `AUDITORIA_INSERT_EMPLEADO` BEFORE INSERT ON `empleado` FOR EACH ROW INSERT INTO auditoria_empleado
(DOC_EMPLEADO_NUEVO,
...
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `AUDITORIA_INSERT_INSUMO` BEFORE INSERT ON `insumo` FOR EACH ROW insert into auditoria_insumo
(NOMBRE_INSUMO_NUEVO,
...
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `AUDITORIA_INSERT_MESA` BEFORE INSERT ON `mesa` FOR EACH ROW insert into auditoria_mesa
(
...
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `AUDITORIA_INSERT_PRODUCTO` BEFORE INSERT ON `producto` FOR EACH ROW insert into auditoria_producto
...
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `AUDITORIA_INSERT_PROVEEDOR` BEFORE INSERT ON `proveedor` FOR EACH ROW insert into auditoria_proveedor
...
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `AUDITORIA_INSERT_RESERVACION` BEFORE INSERT ON `reservacion` FOR EACH ROW insert into auditoria_reservacion
(
ID_CLIENTE_NUEVO,
...
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `AUDITORIA_INSERT_RESERVACION_RESERVA_MESA` BEFORE INSERT ON `reservacion_reserva_mesa` FOR EACH ROW insert into auditoria_reservacion_reserva_mesa
...
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `AUDITORIA_INSERT_USUARIO` BEFORE INSERT ON `usuario` FOR EACH ROW insert into auditoria_usuario
...
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `AUDITORIA_UPDATE_ADMIN` BEFORE UPDATE ON `administrador` FOR EACH ROW insert into auditoria_admin
(NOMBRE_ADMIN_ANTERIOR,
APELLIDO_ADMIN_ANTERIOR,
EMAIL_ADMIN_ANTERIOR,
CELULAR_ADMIN_ANTERIOR,
...
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `AUDITORIA_UPDATE_CATEGORIA_INSUMO` BEFORE UPDATE ON `categoria_insumo` FOR EACH ROW insert into auditoria_categoria_insumo
(NOMBRE_CATEGORIA_INSUMO_ANTERIOR,
NOMBRE_CATEGORIA_INSUMO_NUEVO,
AUDI_FECHA_MODIFICACION,
AUDI_USUARIO,
...
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `AUDITORIA_UPDATE_CATEGORIA_PRODUCTO` BEFORE UPDATE ON `categoria_producto` FOR EACH ROW insert into auditoria_categoria_producto
(NOMBRE_CATEGORIA_PRODUCTO_ANTERIOR,
NOMBRE_CATEGORIA_PRODUCTO_NUEVO,
AUDI_FECHA_MODIFICACION,
AUDI_USUARIO,
...
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `AUDITORIA_UPDATE_CLIENTE` BEFORE UPDATE ON `cliente` FOR EACH ROW insert into auditoria_cliente
(NOMBRE_CLIENTE_ANTERIOR,
APELLIDO_CLIENTE_ANTERIOR,
FECHA_NACIMIENTO_CLIENTE_ANTERIOR,
EMAIL_CLIENTE_ANTERIOR,
...
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `AUDITORIA_UPDATE_EMPLEADO` BEFORE UPDATE ON `empleado` FOR EACH ROW insert into auditoria_empleado
(DOC_EMPLEADO_ANTERIOR,
NOMBRE_EMPLEADO_ANTERIOR,
APELLIDO_EMPLEADO_ANTERIOR,
EMAIL_EMPLEADO_ANTERIOR,
...
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `AUDITORIA_UPDATE_INSUMO` BEFORE UPDATE ON `insumo` FOR EACH ROW insert into auditoria_insumo
(NOMBRE_INSUMO_ANTERIOR,
CANTIDAD_INSUMO_ANTERIOR,
FECHA_COMPRA_INSUMO_ANTERIOR,
VALOR_INSUMO_ANTERIOR,
...
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `AUDITORIA_UPDATE_PROVEEDOR` BEFORE UPDATE ON `proveedor` FOR EACH ROW insert into auditoria_proveedor
(NOMBRE_PROVEEDOR_ANTERIOR,
DIRECCION_PROVEEDOR_ANTERIOR,
PERSONA_ENCARGADA_ANTERIOR,
TELEFONO_PROVEEDOR_ANTERIOR,
...
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `AUDITORIA_UPDATE_RESERVACION` BEFORE UPDATE ON `reservacion` FOR EACH ROW insert into auditoria_reservacion
(ID_CLIENTE_ANTERIOR,
FECHA_RESERVACION_ANTERIOR,
HORA_RESERVACION_ANTERIOR,
ESTADO_RESERVACION_ANTERIOR,
...
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `AUDITORIA_UPDATE_RESERVACION_RESERVA_MESA` BEFORE UPDATE ON `reservacion_reserva_mesa` FOR EACH ROW insert into auditoria_reservacion_reserva_mesa
(ID_RESERVACION_ANTERIOR,
ID_MESA_ANTERIOR,
ID_RESERVACION_NUEVO,
ID_MESA_NUEVO,
...
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `AUDITORIA_UPDATE_USUARIO` BEFORE UPDATE ON `usuario` FOR EACH ROW insert into auditoria_usuario
(NOMBRE_USUARIO_ANTERIOR,
CLAVE_USUARIO_ANTERIOR,
TIPO_USUARIO_ANTERIOR,
ESTADO_USUARIO_ANTERIOR,
