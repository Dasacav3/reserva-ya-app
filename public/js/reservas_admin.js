...
function mostrarMesa() {
	fetch("http://localhost/reservaya-mvc/app/models/admin/reservas/mostrarMesa.php", {
		method: "POST",
	})
		.then((response) => response.text())
		.then((response) => {
...
function listarReservas(search) {
	fetch("http://localhost/reservaya-mvc/app/models/admin/reservas/listarReserva.php", {
		method: "POST",
		body: search,
	})
	...
	if (
		...
		async function añadirReserva() {
			try {
				...
				const add = await fetch("http://localhost/reservaya-mvc/app/models/admin/reservas/añadirReserva.php", {
					method: "POST",
...
function Editar(id) {
	fetch("http://localhost/reservaya-mvc/app/models/admin/reservas/actualizarReserva.php", {
		method: "POST",
		body: id,
	})
		.then((response) => response.json())
...
edit.addEventListener("click", () => {
	...
	if (fecha_reserva1.value == "" || fecha_reserva1.value == "0000-00-00") {
		...
		fetch("http://localhost/reservaya-mvc/app/models/admin/reservas/editarReserva.php", {
			method: "POST",
