...
function listarUsuarios(busqueda) {
	fetch("http://localhost/reservaya-mvc/app/models/admin/usuarios/listarUser.php", {
		method: "POST",
		body: busqueda,
	})
...
registrar.addEventListener("click", () => {
	...
	if(doc.value == "" && nombre.value == "" && apellido.value == "" && email.value == "" && cel.value == "" && pass.value == "" && pass2.value == ""){
		...
		fetch("http://localhost/reservaya-mvc/app/models/admin/usuarios/añadirUser.php", {
			method: "POST",
...
function Editar(id) {
	fetch("http://localhost/reservaya-mvc/app/models/admin/usuarios/actualizarUser.php", {
		method: "POST",
		body: id,
	})
		.then((response) => response.text())
...
function editarEmpleado() {
	...
	if (estado.value == "") {
		...
		fetch("http://localhost/reservaya-mvc/app/models/admin/usuarios/editarUser.php", {
			method: "POST",
...
function eliminarUser(id) {
	Swal.fire({
		...
		if (result.isConfirmed) {
			fetch("http://localhost/reservaya-mvc/app/models/admin/usuarios/eliminarUser.php", {
				method: "POST",
				body: id,
			})
				.then((response) => response.text())
